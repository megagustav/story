...
$title		= "better baby food";
$location	= "/schmiddem, berlin";
$goal		= "concept presentation with market positioning and value proposition model";
$tasks		= "CAD modelling, workshop and rapid prototyping, rendering, client presentation";
$id			= $chapter_list[$i][2];
?>
...
<div class="row m-0 p-0 mt-5">
	<div class="col-md m-0 p-0">
	    <div class="masonry gallery gap-wide">
			<img class="mb-3 gap-wide" src="/_chapters/<?php echo $id; ?>/1.jpg" alt=""/>
			<img class="mb-3 gap-wide" src="/_chapters/<?php echo $id; ?>/2.jpg" alt=""/>
			<img class="mb-3 gap-wide pt-md-5 mt-md-5" src="/_chapters/<?php echo $id; ?>/3.jpg" alt=""/>
	    </div>
	</div>
</div>
...
<div class="row mt-md-5 pt-md-5">
	<div class="col-12">
		<img class="img-fluid" src="/_chapters/<?php echo $id; ?>/4.jpg" alt="Spark hero"/>
	</div>
</div>

<div class="col d-md-none mt-0 mt-md-5" >
	<p class="h4 font-weight-light display-4 text-muted">—</p>
</div>
