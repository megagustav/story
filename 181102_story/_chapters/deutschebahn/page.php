...
$title		= "deutsche bahn UI/UX";
$location	= "/personal project";
$goal		= "redesigning the german railway app for an overall better experience with a focus on facilitating repeated interactions";
$tasks		= "designing in illustrator and sketch, prototyping in principle and aftereffects, testing on iphone";
$id			= $chapter_list[$i][2];
?>
