...
$goal		= "modern, responsive website with the design department's branding and the year's ethos";
$tasks		= "concept presentations and selection, wordpress, writing code, browser testing, bug fixes";
$id			= $chapter_list[$i][2];
?>
