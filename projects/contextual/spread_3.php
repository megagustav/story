<div class="spread">
  <div class="col-md-10 p-0">
	  ...
	  <div class="text-muted text-uppercase pb-5">
		  <small class="float-left"><?php echo $project_1 ?> &mdash; </small>
		  <small class ="float-right"><?php echo ++$p1 ?>. User Experience</small>
		</div>

    <div class="masonry gallery gap-wide">
      <img class="gap-wide" src="<?php dirname(__FILE__) ?>/3.jpg" alt="Chania">
